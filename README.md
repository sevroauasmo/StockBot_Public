...
To get started:
1. Download the packages in the requirements file (I break this up into the venv 'SB' for all scraping/feature eng/cleanup, and 'ML' for the tensorflow and stock purchase flow
